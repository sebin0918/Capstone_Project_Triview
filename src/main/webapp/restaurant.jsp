...
<title>Triview Restaurant</title>
...
try {
	...
	<% 
    while (rs.next()) {
        double lon = rs.getDouble("R_Xloc");
        double lat = rs.getDouble("R_Yloc");
...
%>
	...
	<script>
var HOME_PATH = 'C:\Users\sebin\eclipse-workspace\Triview_test1\src\main\webapp\image\토다3.jpg'; // 실제 이미지 파일이 위치한 경로로 수정해야 합니다.
